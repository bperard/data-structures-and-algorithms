...
describe('Hashtable', () => {
  ...
  it('Left joins two hashmaps into a new hashmap and returns the buckets', () => {
    const hash1 = new Hashtable(1024);
    ...
    const hash2 = new Hashtable(1024);
    ...
    const joinedBuckets = joinHash.leftJoin(hash1, hash2);

    expect(joinedBuckets).toEqual([
