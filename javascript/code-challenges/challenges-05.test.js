...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((nameArray, character) => nameArray = [...nameArray, character.name], []);
};
...
const reversedString = (str) => {
  ...
  return strArray.reduce((revString, char) => `${char}${revString}`, '');
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((total, character) => character.children ? total + character.children.length : total, 0);
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  return arr.reduce((average, num, index) => average = ((average * index) + num) / (index + 1), 0);
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((totalPrimes, num) => isPrime(num) ? totalPrimes + 1 : totalPrimes, 0);
};
...
const extractStats = (snorlaxData) => {
  // Solution code here...
  return snorlaxData.stats.reduce((snorlaxStats, stat) => snorlaxStats = {
    ...snorlaxStats,
...
const extractChildren = (arr) => {
  // Solution code here...
  const charactersEh = arr.filter(character => character.name.includes('a'));
  return charactersEh.reduce((children, character) => character.children ? children = [...children, ...character.children] : children, []);
};
