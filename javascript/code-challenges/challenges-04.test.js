...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort((objectA, objectB) => objectA.price - objectB.price);
};
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  return arr.sort((stringA, stringB) => stringA.toLowerCase() < stringB.toLowerCase() ? -1 :
      stringA.toLowerCase() > stringB.toLowerCase() ? 1 : 0 );
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  return arr.sort((numA, numB) => `${numA}`.length - `${numB}`.length);
};
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((personA, personB) => personA.lastName < personB.lastName ? -1 :
    personA.lastName > personB.lastName ? 1 : 0);
};
...
const sortPeopleBetter = (arr) => {
  ...
  return arr.sort((personA, personB) => {
    return personA.lastName < personB.lastName ? -1 :
      personA.lastName > personB.lastName ? 1 :
        personA.firstName < personB.firstName ? -1 :
          personA.firstName > personB.firstName ? 1 :
            personA.age < personB.age ? -1 :
              personA.age > personB.age ? 1 : 'clone';
  });
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((meetingA, meetingB) => {
    ...
    return dayOrderObject[meetingA.dayOfWeek] - dayOrderObject[meetingB.dayOfWeek] !== 0 ? dayOrderObject[meetingA.dayOfWeek] - dayOrderObject[meetingB.dayOfWeek] :
      meetingA.start - meetingB.start !== 0 ? meetingA.start - meetingB.start :
        meetingA.end - meetingB.end;
  });
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((meetingA, meetingB) => {
    ...
    return dayOrderObject[meetingA.dayOfWeek] - dayOrderObject[meetingB.dayOfWeek];
  });
};
