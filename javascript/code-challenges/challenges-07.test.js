...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  return starWarsArr.sort((charA, charB) => charB.height - charA.height);
};
...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.ingredients.map(ingredient => result.push(ingredient.slice(ingredient.indexOf(' ', ingredient.indexOf(' ') + 1) + 1)));
  return result;
};
...
const splitFoods = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.ingredients.map(ingredient => result.push(ingredient.split(' ').slice(2).join(' ')));
  return result;
};
...
const stepActions = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.steps.map(step => result.push(step.split(' ')[0]));
  return result;
};
...
const totalSumCSV = (str) => {
  let total = 0;
  // Solution code here...
  str.split(',').map(value => total += parseInt(value));
  return total;
};
...
const extractVowels = (str) => {
  ...
  const vowels = ['a', 'e', 'i', 'o', 'u'];
  const removedVowels = [];
  const consonantStr = str.split('').map(char => {
  ...
  return [consonantStr, removedVowels.sort().join('')];
};
